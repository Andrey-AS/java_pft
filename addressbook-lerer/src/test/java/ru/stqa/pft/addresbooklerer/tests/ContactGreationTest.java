...
public class ContactGreationTest extends TestBase {
  ...
  public void testContactGreation() {
    ...
    app.getGroupHelper().fillContactFor(new ContactData("Серега", "Отчество", "Фамилия", "Ник", "Название", "Компания", "адресссс", "Дом", "мобила", "рабочий", "факс", "sdfsldkfsl@mail.ru", "lsdkjklsdkl3.sdk@mail.ru", "домашняя страница", "1978", "1999", "дополнительный адрес", "доп телефон", "доп примечание"));
